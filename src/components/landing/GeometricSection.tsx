...
export const GeometricSection: React.FC<GeometricSectionProps> = ({
    ...
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#0a192f]">
            <div
                className="absolute inset-0 bg-gradient-to-br from-[#112240]/[0.05] via-transparent to-[#64ffda]/[0.05] blur-3xl"/>
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6">
              ...
              <span className="bg-clip-text text-transparent bg-gradient-to-b from-[#ccd6f6] to-[#8892b0]">
                ...
                {title}
                    ...
                    >
                        <button
                            className="px-6 py-3 bg-transparent border-2 border-[#64ffda] text-[#64ffda] rounded-md hover:bg-[#64ffda]/10 transition-colors duration-300 font-mono">
                            Explore My Work
                        </button>
                    </motion.div>
                </div>
            ...
            <div
                className="absolute inset-0 bg-gradient-to-t from-[#0a192f] via-transparent to-[#0a192f]/80 pointer-events-none"/>
        </div>
    );
};
