...
export const ArtisticSection: React.FC<ArtisticSectionProps> = ({
    ...
    return (
        ...
        >
            <div
                className="absolute inset-0 bg-gradient-to-br from-[#7928ca]/[0.15] via-transparent to-[#ff0080]/[0.15] blur-3xl"/>
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6">
              ...
              <span className="bg-clip-text text-transparent bg-gradient-to-b from-white to-white/80">
                {name}
                            ...
                            <br/>
                            <span
                                className="bg-clip-text text-transparent bg-gradient-to-r from-[#7928ca] via-[#ff0080] to-[#ff4d4d]">
                {title}
              </span>
                        </h1>
                    </motion.div>
            ...
            <div
                className="absolute inset-0 bg-gradient-to-t from-[#1a0b2e] via-transparent to-[#1a0b2e]/80 pointer-events-none"/>
        </div>
    );
};
